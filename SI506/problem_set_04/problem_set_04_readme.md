...
string / list manipulation, applying functions in for loop, and also using data retrieved from a .csv file. Students will also gain experience writing to a file. 

You will use `problem_set_04.py` to complete the assignment. You can retrieve it from Canvas or from the
