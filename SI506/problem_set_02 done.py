...
for a in great_wall_list:
    great_wall_item_length.append(len(a))
...
great_wall_string = great_wall_list[1]+' is'+' in '+great_wall_list[0]
...
unesco_sites = []
for b in china_unesco_sites:
    lst = b.split(',')
    if lst[2] == 'Cultural':
        unesco_sites.append(lst[0]+ ' - '+lst[1]+ ' - '+ lst[-1])
